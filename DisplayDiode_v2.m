...
set(leg,'Interpreter','latex','location','northwest','Orientation','horizontal');
set(leg,'FontSize',20);
ax = gca;
...
ylabel('$\Delta_A$ [eV]','interpreter','latex','Fontsize',20)
xlabel('$q_x a$','interpreter','latex','Fontsize',15)
...
ylabel('$\Delta_B$ [eV]','interpreter','latex','Fontsize',20)
xlabel('$q_x a$','interpreter','latex','Fontsize',15)
%%
subplot(2,2,3)
grid off
...
yticks((-2.5:2.5:2.5)/1000)
yticklabels(string(((-2.5:2.5:2.5)/1000)))
xticks((-0.5:0.25:0.5))
xticklabels(string((-0.5:0.25:0.5)))
ylim([-2.5 2.5]/1000)

ylabel('$J_x$','interpreter','latex','Fontsize',20)
xlabel('$q_x a$','interpreter','latex','Fontsize',15)
...
set(gcf,'position',[x0,y0,width,height])
set(gca,'TickLength',[0.015 0.015]);
plot(DE, eta,'k-o','Linewidth',2);
ylabel('$\eta$','interpreter','latex','Fontsize',20)
xlabel('$\Delta_E$','interpreter','latex','Fontsize',15)
